...
$registro = $mysql -> query("SELECT * FROM productos WHERE IDproducto = '$_REQUEST[IDproducto]'") or die($mysql -> error);

if ($reg = $registro -> fetch_array()) 
{
  $strID = $reg['IDproducto'];
          ...
          <div class="col-12 col-md-8 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="active"><a href="empleado.html"><span>Cuenta</span></a></li>
        ...
        <div class="row">
          <div class="col-md-7 mb-5"  data-aos="fade">
            ...
            <div class="p-5 bg-white" style="margin-top: -150px;">
              ...
              <form action= "mostrarProd.php" method = "POST">
                
               
               <div class="row form-group">
                  <div class="col-md-4 mb-6 mb-md-0">
                    <label class="text-black" for="IDproducto">IDproducto</label>
                    <input type="text" value= "<?php echo $reg['IDproducto'];?>" name ="IDproducto" class="form-control" required>
                  </div>

                  <div class="col-md-6 mb-6 mb-md-0">
                    <label class="text-black" for="Nombre">Nombre del producto</label>
                  ...
                  <div class="col-md-8 mb-8 mb-md-0">
                    <label class="text-black" for="Precio">Precio del producto</label>
                    <input type="text" value= "<?php echo $reg['Precio'];?>" name="Precio" class="form-control" disabled = "disabled">
                  </div>
                  <div class="col-md-10 mb-10 mb-md-0">
                    <label class="text-black" for="Cantidad">Cantidad del producto</label>
                    <input type="text" value= "<?php echo $reg['Cantidad'];?>" name="Cantidad" class="form-control" disabled = "disabled">
                  </div>
                </div>   
                  <div class="row form-group">
