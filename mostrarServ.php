...
$registro = $mysql -> query("SELECT * FROM servicios WHERE IDservicio = '$_REQUEST[IDservicio]'") or die($mysql -> error);

if ($reg = $registro -> fetch_array()) 
{
  $strID = $reg['IDservicio'];
        ...
        <div class="row">
          <div class="col-md-7 mb-5"  data-aos="fade">
            ...
            <div class="p-5 bg-white" style="margin-top: -150px;">
              ...
              <form action= "BuscarServ.html" method = "POST">
                
               
               <div class="row form-group">
                  <div class="col-md-4 mb-6 mb-md-0">
                    <label class="text-black" for="IDservicio">IDservicio</label>
                    <input type="text" value= "<?php echo $reg['IDservicio'];?>" name ="IDservicio" class="form-control" required>
                  </div>

                  <div class="col-md-6 mb-6 mb-md-0">
                    <label class="text-black" for="Nombre">Nombre del servicio</label>
                  ...
                  <div class="col-md-8 mb-8 mb-md-0">
                    <label class="text-black" for="Precio">Precio del servicio</label>
