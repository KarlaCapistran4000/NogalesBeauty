...
$registro = $mysql -> query("SELECT * FROM cita WHERE IDcita = '$_REQUEST[IDcita]'") or die($mysql -> error);

if ($reg = $registro -> fetch_array()) 
{
  $strID = $reg['IDcita'];
  $strServicio = $reg['Servicio'];
  $strFecha = $reg['Fecha'];
  $strHora = $reg['Hora'];
          ...
          <div class="col-12 col-md-8 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="active"><a href="login.html"><span>Contáctanos</span></a></li>
          ...
          <div class="col-md-10">
            ...
            <div class="row justify-content-center mb-4">
              <div class="col-md-10 text-center">
                <h1 data-aos="fade-up" class="mb-5">Ponte  <span class="typed-words"></span></h1>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-7 mb-5"  data-aos="fade">
              ...
              <div class="row form-group">
                <form action= "mostrarCita.html" method = "POST">

                    <div class="col-md-2 mb-3 mb-md-0">                
                    <label class="text-black" for="IDcita">IDcita</label>
                    <input type="text" value= "<?php echo $reg['IDcita'];?>" name ="IDcita" class="form-control" required="required">
                    </div>
             ...
             <div class="col-md-6 mb-3 mb-md-0">
                  <label class="text-black" for="Servicio">Servicio</label>
                  <input type="text" value= "<?php echo $reg['Servicio'];?>" name="Servicio" class="form-control" disabled="disabled">

              <label class="text-black" for="Fecha">Fecha programada:</label> 
                <input type="date" value= "<?php echo $reg['Fecha'];?>" name="Fecha" min="2020-06-21" disabled="disabled">
              <label class="text-black" for="Hora">Hora programada:</label> 
                <input type="time" value= "<?php echo $reg['Hora'];?>" name="Hora" min="8:00" max="17:00" disabled="disabled">
                </div>
              </div>
