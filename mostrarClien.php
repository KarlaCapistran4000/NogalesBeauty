...
$registro = $mysql -> query("SELECT * FROM clientes WHERE IDcliente = '$_REQUEST[IDcliente]'") or die($mysql -> error);
        ...
        <div class="row">
          <div class="col-md-7 mb-5"  data-aos="fade">
            ...
            <div class="p-5 bg-white" style="margin-top: -150px;">
              ...
              <form action= "mostrarClien.html" method = "POST">
               ...
               <h1> Cliente </h1> 
                ...
                <div class="row form-group">
                   ...
                   <div class="col-md-4 mb-3 mb-md-0">
                    ...
                    <label class="text-black" for="IDcliente">IDcliente</label>
                    <input type="text" value= "<?php echo $reg['IDcliente'];?>" name ="IDcliente" class="form-control" required="required">
                    </div>
